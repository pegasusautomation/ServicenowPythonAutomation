...
def getrequestitemdesc() -> list:
    ...
    #     match argument:
    #         case "AMOLEDBlack":
    #             print("I download AMOLEDBlack report")
    #         case "Lenovo":
    #             print("I download Lenovo report")
    #         case "Retina":
    #             print("I download Retina report")
    #         case "Intel":
    #             print("I download Intel report")
    #         case "ThinkPad":
    #             print("I download ThinkPad report")
